...
analysis_meson_2pt <- function(analyses_to_be_done_input,kappa,boot.R=400,boot.l=10,debug=F,pause=F,skip=0) {
...
#  light_masses <- c(0.0009)
  ...
  analyses[[1]] <- list( dirs=dirs$ll_c, name="pion_charged", mass_diagonal=TRUE, q_masses=mass_comb$ll,
                         t1=11, t2=23, t1_plot=5, t2_plot=24, basename="outprcv.", observable=c(1), sign=c(1) )

  analyses[[2]] <- list( dirs=dirs$ls_c, name="kaon_charged", mass_diagonal=FALSE, q_masses=mass_comb$ls,
                         t1=12, t2=47, t1_plot=8, t2_plot=48, basename="outprcv.", observable=c(1), sign=c(1) )

  analyses[[3]] <- list( dirs=dirs$lc_c, name="D_charged", mass_diagonal=FALSE, q_masses=mass_comb$lc,
                         t1=12, t2=47, t1_plot=8, t2_plot=48, basename="outprcv.", observable=c(1), sign=c(1) )

  analyses[[4]] <- list( dirs=dirs$sc_c, name="Ds_charged", mass_diagonal=FALSE, q_masses=mass_comb$sc,
                         t1=15, t2=47, t1_plot=8, t2_plot=48, basename="outprcv.", observables=c(1), sign=c(1) )
  
  analyses[[5]] <- list( dirs=dirs$ll_na, name="pion_neutral_ud", mass_diagonal=TRUE, q_masses=mass_comb$ll,
                         t1=11, t2=23, t1_plot=5, t2_plot=24, basename="outprcvn.", observable=c(5), sign=c(-1),
                         disonnected_part=TRUE, disc_basename="disc.0.1373.0.006.k0v4", disc_observable=c(9), disc_sign=c(1) )
  
  analyses[[6]] <- list( dirs=dirs$ll_nb, name="pion_neutral_du", mass_diagonal=T, q_masses=mass_comb$ll,
                         t1=11, t2=23, t1_plot=5, t2_plot=24, basename="outprcvn.", observable=c(5), sign=c(-1),
                         disonnected_part=TRUE, disc_basename="disc.0.1373.0.006.k0v4", disc_observable=c(9), disc_sign=c(1) )
